...
CREATE
DATABASE IF NOT EXISTS `celeb_match` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE
`celeb_match`;
...
(
    50
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Nghề nghiệp (diễn viên, ca sĩ, đạo diễn,...)',
    `nationality` varchar
(
    50
...
(
    100
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Nơi sống/làm việc (thành phố, quốc gia)',
